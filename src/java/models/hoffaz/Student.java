...
public class Student {
    ...
    public Student(int studentId, String firstName, String secondName, String thirdName, String familyName, Timestamp birthDate, int sexId, Timestamp dateOfJoin, int nationalityId, int nationalityNumber, String phone, String whatsup, int branchId, int centerId, int tripId, int stopId, String addressDetails, boolean transportation, int insertEmployeeId, String insertHostIp, Timestamp insertDate, String insertHostOS, int updatEmployeeId, Timestamp updateDate, String updateHostIp, String updateHostOS) {
